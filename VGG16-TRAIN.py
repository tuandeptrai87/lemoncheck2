...
plot_dir  = 'plots'
model_path = os.path.join(data_dir, 'vgg16_4.h5')
...
# Load and freeze VGG16 base model
...
save_plot('accuracy', 'Model Accuracy over Epochs', 'accuracy_vgg16.png')
save_plot('loss', 'Model Loss over Epochs', 'loss_vgg16.png')
save_plot('precision', 'Model Precision over Epochs', 'precision_vgg16.png')
save_plot('recall', 'Model Recall over Epochs', 'recall_vgg16.png')
...
# Bar charts for validation vs test
for idx, label in enumerate(labels):
    ...
    plt.tight_layout()
    fname = f'{label}_val_test_vgg16.png'
